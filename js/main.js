const perguntas = [
  ...
  {
    pergunta: "Qual é função do operador '===' em comparações em JavaScript?",
    respostas: [
  ...
  {
    pergunta:
      "Qual diferença entre 'let' e 'const' na declaração de variáveis?",
    respostas: [
      "Nenhuma, são sinónimos",
      "let é usado para valores constantes, constantes para variáveis",
...

  {
    ...
    respostas: [
      ...
      "Um método de objeto para manipular documentos HTML",
  ...
  {
    pergunta: "Como se adiciona um evento a um elemento HTML em JavaScript?",
    respostas: [
      "Apenas com CSS",
      "Usando a atributo 'event'",
